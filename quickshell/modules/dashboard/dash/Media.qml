...
Item {
    ...
    AnimatedImage {
        ...
        playing: (Players.active !== null && Players.active !== undefined) ? Players.active.isPlaying : false
        speed: BeatDetector.bpm / 240  // Use BPM for speed, with minimum to prevent stopping
